...
function PluginIcon(props) {
  return /* @__PURE__ */ jsx("svg", { viewBox: "0 0 24 24", fill: "none", "aria-hidden": true, focusable: "false", ...props, children: /* @__PURE__ */ jsx(
    "path",
    {
...
const index = {
  ...
  bootstrap(app) {
    app.addSettingsLink("global", {
      ...
      to: "rankpine",
      Component: () => import("./Settings-Coel0Gz6.js"),
      permissions
    });
  },
  async registerTrads({ locales }) {
    return Promise.all(
      locales.filter((locale) => locale === "en").map(async (locale) => ({
        data: (await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => import("./en-BTIR1dvc.js") }), `./translations/${locale}.json`, 3)).default,
        locale
      }))
    );
  }
